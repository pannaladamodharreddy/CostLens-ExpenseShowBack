...
def lambda_handler(event, context):
    ...
    try:
        ...
        qry_str_insert = ''
        for value in values:
            qry_str_insert+= """INSERT INTO dev.public.shared_service_usage_data(metric_date,cost_center_id,usage_metric_units,primary_metric_dimension,secondary_metric_dimension
            ,service_name)
            values ('{}','{}','{}','{}','{}');
            """.format(*value)
